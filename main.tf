...
module "elb" {
  source      = "https://github.com/sarmistha-jena/TerraformProjects.git//Projects/Assignment_ELB/module/elbModule"
...
module "asg" {
  source      = "https://github.com/sarmistha-jena/TerraformProjects.git//Projects/Assignment_ELB/module/asgModule"
