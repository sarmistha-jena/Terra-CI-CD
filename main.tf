...
module "elb" {
  source      = "https://github.com/sarmistha-jena/TerraformProjects.git//Projects/Assignment_ELB/module/elbModule?ref=master"
...
module "asg" {
  source      = "https://github.com/sarmistha-jena/TerraformProjects.git//Projects/Assignment_ELB/module/asgModule?ref=master"
